...
export default function EditSubCategory() {
    const { props } = usePage();
    const { auth, subcategory, categories } = props;
    ...
    const handleModalClose = () => {
        setShowModal(false);
        Inertia.visit('/product/management/subcategories');
    };

    const handlePurgeModalOpen = (subcategoryId) => {
                ...
                <div className="max-w-2xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 bg-white border-b border-gray-200">
                            <h2 className="font-semibold text-xl text-gray-800 leading-tight text-center mb-6">Edit SubCategory</h2>
                            <form onSubmit={handleSubmit} className="flex flex-col items-center pb-20">
                                ...
                                <div className="flex justify-center space-x-2 mt-4">
                                    ...
                                    <button type="button" onClick={() => handlePurgeModalOpen(subcategory.id)} className="px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:w-auto sm:text-sm">
                                        Purge
                                    </button>
                                </div>
                            </form>
