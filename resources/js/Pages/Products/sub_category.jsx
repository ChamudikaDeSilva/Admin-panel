...
export default function Categories({ auth }) {
    ...
    const handleSelectSubCategory = (subcategoryId) => {
        ...
        const handleSelectAllSubCategories = (e) => {
            if (e.target.checked) {
                const allSubCategoryIds = currentSubCategories.map((subcategory) => subcategory.id);
        ...
        const confirmDeleteSubCategories = async () => {
            try {
                await axios.post(route('subcategories.deleteMultiple'), { subcategory_ids: selectedSubCategories });
                setSelectedSubCategories([]);
                fetchSubCategories();
                setIsPurgeModalOpen(false);
            } catch (error) {
                console.error('An error occurred while deleting subcategories:', error);
            }
        };
                                ...
                                <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                    ...
                                    <div className="bg-gray-50 px-4 py-3 sm:px-6">
                                        <div className="flex flex-col sm:flex-row sm:justify-end">
                                            ...
                                            <button onClick={confirmDeleteSubCategories} type="button" className="w-full sm:w-auto mb-2 sm:mb-0 inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:text-sm">
                                                Delete
                                            </button>
